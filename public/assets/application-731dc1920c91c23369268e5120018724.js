...
(function() {
  var postMap, progress, resetProgress, resetProgressPerfil;

  $(function() {
    var $container, map;
    $('a#documentos').click(function() {
      var myPDF;
      return myPDF = new PDFObject({
        url: "cv.pdf"
      }).embed('pdf');
    });
    $('a#showpdf').click(function() {
      return $('div#pdf').fadeToggle();
    });
    map = new GMaps({
      div: '#map',
      lat: 45.803212,
  ...
  resetProgress = function(e) {
    e.preventDefault();
    return $('.meter').animate({
      width: "0%"
    }, 0);
  };

  resetProgressPerfil = function(e) {
    e.preventDefault();
    return $('.meter').animate({
      width: "0%"
    }, 0);
  ...
  progress = function() {
    ...
    $('.meter.sinatra').animate({
      width: "90%"
    }, 600);
    $('.meter.jquery').animate({
      width: "90%"
    }, 600);
    $('.meter.ajax').animate({
      width: "90%"
    }, 600);
    $('.meter.backbone').animate({
      width: "55%"
    }, 600);
    $('.meter.angular').animate({
      width: "65%"
    }, 600);
    $('.meter.mysql').animate({
      width: "90%"
    ...
    $('.meter.networking').animate({
      width: "80%"
    }, 600);
    $('.meter.security').animate({
      width: "85%"
    }, 600);
    $('.meter.ps').animate({
      width: "75%"
    }, 600);
    $('.meter.indesign').animate({
      width: "70%"
    }, 600);
    $('.meter.tb').animate({
      width: "90%"
    ...
    $('.meter.heroku').animate({
      width: "95%"
    }, 600);
    $('.meter.vps').animate({
      width: "90%"
    }, 600);
    return $('.meter.infrastructure').animate({
      width: "70%"
    }, 600);
  };

  window.startup = function() {
    return $('.meter.test').animate({
      width: "0%"
    }, 0, function() {
      $('.meter.ruby').animate({
        width: "90%"
      }, 600);
      return $('.meter.javascript').animate({
        width: "70%"
      }, 600);
    });
  };
